...
public class CollectionActivity extends AppCompatActivity {
    ...
    private void findViews(){
        drawerLayout = findViewById(R.id.collection_draw);
    ...
    private void setListeners(){
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CollectionActivity.this, RegisterActivity.class);
        ...
        userImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CollectionActivity.this, PersonInfoActivity.class);
        ...
        userCharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CollectionActivity.this, ChargeActivity.class);
                startActivity(intent);
            }
        });
        ...
        navPublish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(CollectionActivity.this, PublishActivity.class);
                startActivity(intent);
            }
        });
        ...
        navIssued.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(CollectionActivity.this, IssuedActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void init(){
        ...
        adapter = new JobsAdapter(collections);
        adapter.setItemClickListener(new JobsAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                intent.putExtra("job",collections.get(position));
                startActivity(intent);
            }
        });
        adapter.setItemLongClickListener(new JobsAdapter.OnItemLongClickListener() {
            ...
            public void onItemLongClick(int position) {
                showPopupMenu(collectionList.getChildAt(position),position);
            }
        });
        collectionList.setLayoutManager(new LinearLayoutManager(this,RecyclerView.VERTICAL,false));
    ...
    private void setData(){
        String userId = sp.getString("userId","");
        new getCollectionTask().execute(userId);
    ...
    private void showPopupMenu(View v, final int position){
        ...
        getMenuInflater().inflate(R.menu.menu_collection,popupMenu.getMenu());
        popupMenu.show();
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                String id = idList.get(position);
                new delCollectionTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,id,String.valueOf(position));
                return true;
            }
        });
    }

    class getCollectionTask extends AsyncTask<String,Void, Map<String,Job>>{
        @Override
        protected Map<String,Job> doInBackground(String... params) {
            String result = Connection.getCollections(params[0]);
            Gson gson = new Gson();
            return gson.fromJson(result,new TypeToken<Map<String,Job>>(){}.getType());
        }

        @Override
        protected void onPostExecute(Map<String,Job> map) {
            super.onPostExecute(map);
            idList.clear();
            collections.clear();
            for(String id:map.keySet()){
                idList.add(id);
                collections.add(map.get(id));
            }
            adapter.notifyDataSetChanged();
        }
    }

    class delCollectionTask extends AsyncTask<String,Void,Void>{
        @Override
        protected Void doInBackground(String... params) {
            Connection.deleteCollection(params[0]);
            idList.remove(params[1]);
            collections.remove(Integer.parseInt(params[1]));
            return null;
        }
