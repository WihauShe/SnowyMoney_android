...
public class ChargeAdapter extends RecyclerView.Adapter {
    ...
    public ChargeAdapter(List<Money> data, Context context) {
        this.data = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 1) {
            return new MyTextViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_money_text, null));
        } else {
            return new MyEditViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_money_edit, null));
        }
    }
    ...
    class MyTextViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyTextViewHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.money_text);
        }
    }
    ...
    class MyEditViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyEditViewHolder(View itemView) {
            super(itemView);
            editText = (EditText) itemView.findViewById(R.id.money_edit);
        }
    }
