...
public class LatestFragment extends Fragment {
    ...
    private JobsAdapter adapter = new JobsAdapter(jobs);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.jobs_latest, container, false);
        findViews();
        init();
        return view;
    }
    ...
    private void init() {
        ...
        refreshLayout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                ToastUtil.show(getContext(), "刷新完成");
            }
        });
    ...
    class JobTask extends AsyncTask<Void, Void, List<Job>> {
        ...
        protected List<Job> doInBackground(Void... params) {
            String result = Connection.getJobs("1");
            Gson gson = new Gson();
